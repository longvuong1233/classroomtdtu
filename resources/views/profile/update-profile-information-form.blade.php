<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        {{-- Phone Number --}}
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="phoneNumber" value="Phone Number" />
            <x-jet-input id="phoneNumber" type="tel" pattern="0\d{9,20}" class="mt-1 block w-full"
        ...
        {{-- Birthday --}}
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="birthday" value="Birthday" />
